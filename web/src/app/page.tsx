    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white">
      ...
      <div className="px-4 pt-8 pb-20 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="urdu urdu-heading text-3xl md:text-4xl font-bold mb-4">
            <span className="bg-gradient-to-r from-red-400 to-red-600 bg-clip-text">
              {t.home.whyLearnTitle}
            </span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            {t.home.whyLearnDescription}
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {t.home.featureCards.map((feature: any, index: number) => (
            <div 
              key={index}
