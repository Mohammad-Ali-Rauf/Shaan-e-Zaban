      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative flex flex-col items-center px-4 py-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-4">
            ...
            <button className="px-8 py-4 border border-red-600/50 text-red-400 rounded-xl text-lg font-semibold hover:bg-red-900/30 transition-all duration-300 transform hover:scale-105">
              📚 Browse Collection
            </button>
          </div>
      ...
      <div className="border-t border-gray-800 bg-gradient-to-r from-red-900/10 to-black">
        <div className="max-w-4xl mx-auto px-4 py-12 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
            Join hundreds of learners who are improving their Urdu through authentic cultural stories and poetry.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="px-8 py-4 border border-gray-600 text-gray-300 rounded-xl font-semibold hover:border-red-600 hover:text-red-300 transition-colors">
              Learn More
            </button>
          </div>
        </div>
